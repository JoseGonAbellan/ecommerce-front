  ...
  return (
    <div style={{padding: 200}} className= {styles.home}>
      ...
      <div className={styles.categoriesButtons}>
        <CategoryButton title="Juegos de Mesa" color="#9EB384" iconUrl='/images/bg-icon.png' onClick={goProductsPage}/>
        <CategoryButton title="Juegos de Cartas" color="#435334" iconUrl='/images/bg-icon.png' onClick={handleConsole}/>
        <CategoryButton title="Juegos de Rol" color="#9EB384" iconUrl='/images/bg-icon.png' onClick={handleConsole}/>
        <CategoryButton title="Merchandising" color="#435334" iconUrl='/images/bg-icon.png' onClick={handleConsole}/>
      </div>
    </div>
  );
}